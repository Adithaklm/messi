...
async def start(client, message):
    ...
    buttons = [
                    [
                        ...
                        InlineKeyboardButton('💞 sʜᴀʀᴇ', url="https://t.me/share/url?url=Iғ ʏᴏᴜ ᴡᴀɴᴛ ᴀʟʟ ᴛʜᴇ ɴᴇᴡ ᴀɴᴅ ᴏʟᴅ ᴍᴏᴠɪᴇs ᴀɴᴅ ᴡᴇʙsᴇʀɪᴇs, ᴄʟɪᴄᴋ ᴏɴ ᴛʜᴇ ʟɪɴᴋ ʙᴇʟᴏᴡ ᴀɴᴅ ᴊᴏɪɴ ᴛʜᴇ ɢʀᴏᴜᴘ ᴀɴᴅ ʀᴇǫᴜᴇsᴛ") 
                    ],
                    [
